...
use StringHelpers\Str;
	...
	trait Builder {
		...
		protected static function hasOne($associationName, $options = [], $callback = null) {
			...
			static::hasOneAssociations()[$associationName] = new DependentAssociation($associationName, static::class, $primaryKey, $associatedClass, $associatedName, $foreignKey, $through, $as, $sourceType, $callback);
